...
1. Click **Map** under Visualizations, then drag and drop **OriginAirportCode** into the **Legend** field. Refer to the table below for setting the other fields.
    ...
    > **Note**: In case the **Map** doesn't load, navigate to **File > Option and setting > Options > Security**. Scroll down to Map and Filled Map Visuals and check the Use Map and Filled Map Visuals and click on **OK**. 
    
        ![The don't summarize menu option is highlighted.](media/mapsettings.png "Don't summarize")
